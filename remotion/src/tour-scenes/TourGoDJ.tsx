...
export const TourGoDJ: React.FC = () => {
  ...
  const screenScale = interpolate(frame, [0, 320], [1.0, 1.04], { extrapolateRight: "clamp" });

  const features = [
    { icon: "🎧", text: "Curated Mix Sessions", sub: "Build DJ sets from JumTunes tracks", delay: 60 },
    { icon: "🏆", text: "DJ Leaderboards", sub: "Compete for top curator spots", delay: 110 },
    { icon: "💰", text: "Paid Fan Submissions", sub: "Fans pay to get their tracks featured", delay: 160 },
  ];

  return (
    <AbsoluteFill style={{ background: "linear-gradient(180deg, #0a0a0a 0%, #0d0d0d 50%, #0a0a0a 100%)" }}>
      {/* Equalizer bars behind screenshot */}
      <div style={{
