...
export const SignupConfirmationModal = forwardRef<HTMLDivElement, SignupConfirmationModalProps>(
  function SignupConfirmationModal(
    { open, onOpenChange, selectedRole, displayName, email, onConfirm, onChangeRole, isLoading },
    ref
  ) {
