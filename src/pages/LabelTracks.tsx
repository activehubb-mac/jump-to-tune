...
import { useLabelAlbums } from "@/hooks/useAlbums";
...
export default function LabelTracks() {
  const { user, role, isLoading } = useAuth();
  const { data: tracks, isLoading: tracksLoading } = useLabelTracks(user?.id);
  const { data: albums, isLoading: albumsLoading } = useLabelAlbums(user?.id);
      ...
      <Layout>
        <div className="container mx-auto px-4 py-24">
          <div className="max-w-md mx-auto text-center">
            ...
            <h1 className="text-3xl font-bold text-foreground mb-4">Label Tracks</h1>
  ...
  return (
    <Layout>
      <div className="container mx-auto px-4 py-6 sm:py-8">
        ...
        {/* Albums Section */}
        <AlbumSection albums={albums} isLoading={albumsLoading} statsQueryKey="label-stats" />
        ...
        {tracksLoading ? (
          ...
          <div className="glass-card p-12 text-center">
            ...
            <p className="text-muted-foreground mb-6 max-w-md mx-auto">
              Upload your first track to start building your label's catalog.
            </p>
