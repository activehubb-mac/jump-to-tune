...
export default function LabelPayouts() {
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex-1">
            ...
            <p className="text-muted-foreground">
              Manage your label's earnings and payout settings
            </p>
          </div>
          <Button
            variant="ghost"
          ...
          <Card className="glass border-accent/30 mb-8">
            <CardContent className="p-6">
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                ...
                <Button
                  className="bg-accent hover:bg-accent/90 neon-glow-subtle"
          ...
          <div className="lg:col-span-2">
            <Card className="glass">
              <CardHeader>
                ...
                <CardDescription>
                  Your label's latest sales and revenue
                </CardDescription>
              </CardHeader>
              <CardContent>
                {isLoading ? (
