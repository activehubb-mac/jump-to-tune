    ...
    <Layout>
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-bold text-foreground">Label Analytics</h1>
            <p className="text-muted-foreground">Track your label's performance and earnings</p>
          </div>
        </div>
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="text-left text-muted-foreground text-sm border-b border-glass-border">
                        ...
                        <th className="pb-3 font-medium">Label Earnings</th>
                      </tr>
                    </thead>
                    <tbody>
                      {tracks.map((track) => {
                        ...
                        return (
                          <tr key={track.id} className="border-b border-glass-border/50">
                            ...
                            <td className="py-4 text-accent font-medium">
            ...
            <div className="glass-card p-6">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="text-center p-4 rounded-lg bg-accent/20">
                  <p className="text-muted-foreground text-sm mb-2">Label Earnings (85%)</p>
