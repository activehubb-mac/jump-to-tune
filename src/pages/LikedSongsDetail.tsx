        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="flex flex-col md:flex-row gap-6 mb-8">
              ...
              <div className="w-48 h-48 rounded-lg overflow-hidden flex-shrink-0 mx-auto md:mx-0 bg-primary flex items-center justify-center shadow-lg">
                <Heart className="w-20 h-20 text-primary-foreground fill-primary-foreground" />
              </div>
