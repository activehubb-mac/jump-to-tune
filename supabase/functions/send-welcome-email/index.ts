...
const getRoleContent = (role: string) => {
  switch (role) {
    case "artist":
      return {
        emoji: "🎤",
        title: "Welcome to JumTunes, Artist!",
        description: "You're now part of a community of creators who own their music and connect directly with fans.",
        features: [
    ...
    case "label":
      return {
        emoji: "🏢",
        title: "Welcome to JumTunes, Label!",
        description: "Manage your roster of artists and distribute their music to a global audience.",
        features: [
    ...
    default:
      return {
        ...
        description: "Discover unique music and own it forever. Support artists directly and build your collection.",
        features: [
...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const { userId, email, displayName, role }: WelcomeEmailRequest = await req.json();
